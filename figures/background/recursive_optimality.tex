    ...
    \node at (0.4,1.2) {\Large $\rightarrow$};
    \node at (1.2,1.2) {\Large $\rightarrow$};
    \node at (2,1.2) {\Large $\rightarrow$};
    \node at (2.8,1.2) {\Large $\uparrow$};
    \node at (3.6,1.2) {\Large $\uparrow$};

    \node at (0.4,2) {\Large $\downarrow$};
    \node at (1.2,2) {\Large $\downarrow$};
    \node at (2,2) {\Large $\downarrow$};
